...
This report provides an overview of `r params$county` County's demographic, economic, and social makeup, in order to provide additional context for the metrics in the interactive map. 

The county seat of `r params$county` is `r tn_county_seats |> filter(county == params$county) |> pull(var = county_seat)`, Tennessee.

```{r race, fig.height = 2, fig.width = 8}
...
```{r age, fig.height = 2, fig.width = 8}
...
supp_housing |>
  ...
  mutate(
    name = case_when(
      ...
      name == "built_2010_to_2019" ~ "2010-2019",
      name == "built_2000_to_2009" ~ "2000-2009",
      name == "built_1990_to_1999" ~ "1990-1999",
      name == "built_1980_to_1989" ~ "1980-1989",
      name == "built_1970_to_1979" ~ "1970-1979",
      name == "built_1960_to_1969" ~ "1960-1969",
      name == "built_1950_to_1959" ~ "1950-1959",
      name == "built_1940_to_1949" ~ "1940-1949",
