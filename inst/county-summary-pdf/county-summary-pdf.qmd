...
```{r unemployment_graph, fig.height=4}
...
```{r housing_stock_graph, fig.height=2.5}
...
supp_housing |>
  ...
  mutate(
    name = case_when(
      name == "built_2020_or_later" ~ "2020 or Later",
