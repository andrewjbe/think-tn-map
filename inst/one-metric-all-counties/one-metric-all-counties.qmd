...
subtitle: "All Counties: `r params$metric`"
format:
...
This report summarizes the `r params$metric` metric in all `r nrow(main_ds) |> format(big.mark=",")` counties in Tennessee. All data was compiled by Think Tennessee.
...
ds_info_long |>
  ...
  gt(caption = paste0("Metric Details: ", params$metric)) |>
  cols_label(
    name = md(""),
    value = md(""),
  ) |>
...
main_ds |>
  ...
  select(c(county, value_fmt, rank_fmt, 
